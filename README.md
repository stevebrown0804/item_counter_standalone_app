...
* 2026-04-22 We added a UI for adding new 'countable items,' so you don't have to go through the trouble of installing a debug version of the app, copying the DB to your local machine, adding items then copying the DB back to the phone, then installing the retail version of the app, to use.🥳  Alas, you still have to do that with time zones.  (All in good time!)
