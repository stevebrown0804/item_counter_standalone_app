...
* 2026-04-22 We added a UI for adding new 'countable items,' so you don't have to go through the trouble of installing the app, copying the DB to your local machine, adding items then copying the DB back to the phone, to use the app.🥳  Alas, you still have to do that with time zones.
* 
---
